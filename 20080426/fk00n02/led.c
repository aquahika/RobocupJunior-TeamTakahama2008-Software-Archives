...
/********************************************************************************************************************************/
	...
	if((mode!=25)&&(mode!=29)&&(mode!=50)&&(irr+irc+irl>=400)) mode=20;	//中立点モード時以外にボールが発見→通常追いかけるモード
	if((mode==20)&&(irr+irc+irl<400)) mode=0;			//通常追いかけるモードでボールが無かったら
...
/************************************************************ 中立点***/ 
	...
	if((mode==29)&&(irr+irc+irl < 200)) mode=0;
...
/*************************************************************デジタル***/
	...
	if((mode!=50)&&(gr > 160 )&&(p9!=0xff)){			//立ち入り禁止エリアでデジタル赤外線センサーが反応していたら
		if(p9_0==0)mode=0;
		if(p9_1==0)mode=0;
		if(p9_2==0)mode=0;
		if(p9_3==0)mode=63;
	...
	if((mode!=50)&&(gr < 160 )&&(gr > 160 - 30)&&(p9!=0xff)){	//中立点エリアでデジタル赤外線センサーが本能していたら
		if(p9_0==0)mode=70;
		if(p9_1==0)mode=71;
		if(p9_2==0)mode=72;
		if(p9_3==0)mode=73;
	...
	if((mode!=50)&&(gr < 160 - 30)&&(gr > 100 -5 )&&(p9!=0xff)){	//通常動作エリアでデジタル赤外線センサーが反応していたら
		if(p9_0==0)mode=80;
		if(p9_1==0)mode=81;
		if(p9_2==0)mode=82;
		if(p9_3==0)mode=83;
	...
	if((mode!=50)&&(gr < 100-5)&&(p9!=0xff)){			//待機位置以下でデジタル赤外線センサーが反応していたら
		if(p9_0==0)mode=90;
		if(p9_1==0)mode=91;
		if(p9_2==0)mode=92;
		if(p9_3==0)mode=93;
